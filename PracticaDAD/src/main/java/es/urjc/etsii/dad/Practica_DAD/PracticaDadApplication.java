...
public class PracticaDadApplication {
	
	private static final Log LOG = LogFactory.getLog(PracticaDadApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(PracticaDadApplication.class, args);
	}
